...
public class BB8 extends OpMode {
    ...
    private DcMotor head_motor = null;
    ...
    public void init() {
        ...
        head_motor = hardwareMap.get(DcMotor.class, "head_motor");
        ...
        head_motor.setDirection(DcMotor.Direction.FORWARD);
...
//
        ...
        if(rightTrigger){ head_motor.setPower(0.4) ;}
        if(leftTrigger) { head_motor.setPower(-0.4) ;}
    }
